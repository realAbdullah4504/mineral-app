...
const StatisticsEmployement = lazy(() => import("../pages/statistics-employement"));
    ...
    <Suspense fallback={"...Loading"}>
      <Routes>
        ...
        <Route
          ...
          element={<PublicRoute component={GeologicalMap} layout={DashboardLayout} />}
        />
        ...
        />
        <Route path="/fiscal-tax" element={<PublicRoute component={FiscalTax} layout={DashboardLayout} />} />
        <Route path="/governance" element={<PublicRoute component={Governance} layout={DashboardLayout} />} />
        <Route path="/acts-laws" element={<PublicRoute component={ActsLaws} layout={DashboardLayout} />} />
        <Route
          path="/rules-regulations"
          element={<PublicRoute component={RulesRegulations} layout={DashboardLayout} />}
        />
        <Route
          path="/mineral-testing-labs"
          element={<PublicRoute component={MineralTestingLabs} layout={DashboardLayout} />}
        />
        <Route
          path="/test-information"
          element={<PublicRoute component={TestInformation} layout={DashboardLayout} />}
        />
        <Route
          path="/initiatives-projects"
          element={<PublicRoute component={InitiativesProjects} layout={DashboardLayout} />}
        />
        <Route path="/major-mining" element={<PublicRoute component={MajorMining} layout={DashboardLayout} />} />
        <Route path="/training-skill" element={<PublicRoute component={TrainingSkill} layout={DashboardLayout} />} />
        <Route path="/fiscal-tab" element={<PublicRoute component={FiscalTab} layout={DashboardLayout} />} />
        <Route path="/royalty-fee" element={<PublicRoute component={Royalties} layout={DashboardLayout} />} />
        ...
        <Route
          ...
          element={<PublicRoute component={DrillingServices} layout={DashboardLayout} />}
        />
        <Route path="/mineral-labs" element={<PublicRoute component={MineralLabs} layout={DashboardLayout} />} />
        <Route path="/mineral-labs" element={<PublicRoute component={MineralLabs} layout={DashboardLayout} />} />
        <Route path="/mineral-labs" element={<PublicRoute component={MineralLabs} layout={DashboardLayout} />} />
        <Route path="/mineral-labs" element={<PublicRoute component={MineralLabs} layout={DashboardLayout} />} />
        <Route
          path="/downstream-industries"
          element={<PublicRoute component={DownstreamIndustries} layout={DashboardLayout} />}
        />
        <Route
          path="/software-solution"
          element={<PublicRoute component={SoftwareSolution} layout={DashboardLayout} />}
        />
        ...
        <Route
          ...
          element={<PublicRoute component={CSRSuccessStories} layout={DashboardLayout} />}
        />
        <Route path="/csr-community" element={<PublicRoute component={CSRCommunity} layout={DashboardLayout} />} />
        <Route path="/statistics" element={<PublicRoute component={DataStatistics} layout={DashboardLayout} />} />
        <Route
          path="/statistics-revenue"
          element={<PublicRoute component={StatisticsRevenue} layout={DashboardLayout} />}
        />
        <Route
          path="/statistics-employement"
          element={<PublicRoute component={StatisticsEmployement} layout={DashboardLayout} />}
        />
        <Route
          path="/statistics-production"
          element={<PublicRoute component={StatisticsProduction} layout={DashboardLayout} />}
        />
        <Route path="/statistics-ie" element={<PublicRoute component={Statisticsio} layout={DashboardLayout} />} />
        <Route
