...
const StaticDataCard = ({ type, data }) => {
  ...
  return (
    ...
    {type == "add" ? (
      ...
      <div className="w-full max-w-[18rem] border-2 rounded-lg shadow-xl flex flex-col">
        ...
        <div className="space-y-4 p-6 bg-[#f5fffc] flex flex-col justify-between flex-grow">
          ...
          <div className="flex items-center gap-2">
            ...
            <p>{data.address || "Plot No 13, F-10, Islamabad"}</p>
          </div>
