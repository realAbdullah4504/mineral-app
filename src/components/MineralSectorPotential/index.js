...
export const MineralSectorPotential = () => {
  return (
    <div className="flex flex-col pt-[2.25rem] pb-[3.125rem] bg-[#F2F2F3]">
      ...
      <div className="flex justify-center text-center max-w-[700px] mx-auto text-[23px]">
        From economic growth to infrastructure development, mining plays a vital
        role. Embracing responsible practices ensures long-term sustainability.
      </div>
      <div className="flex">
