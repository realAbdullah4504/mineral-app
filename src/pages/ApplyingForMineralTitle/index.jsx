...
import cornerArrow from "assets/images/cornerArrow.svg";
      ...
      <Container classes="mt-8 w-[90%]">
        <div className="page_introduction_section my-5">
          <div className="page-title-main">
            ...
            <h1 className="page-title">
              Applying for <span>Mineral Title</span>
            </h1>
            <p className="intro_parahgraph my-4 font-helvetica">
              Mineral Title" refers to the legal rights granted by the
              government to individuals or companies to explore, develop, and
              extract minerals from a designated area. These titles are
              essential for regulating mining activities and ensuring that
              mineral resources are exploited in an orderly and lawful manner.
              Here are the main types of mineral titles typically found in
              Pakistan:
            </p>
          </div>
        </div>
        <div className="content_area_main">
          <div className="apply_for_mineral_sec_1 xl:py-10 md:py-5 py-4">
            <div className="page_subtitle text-center">
              Mineral Title Fee / Annual <span>Rent & Fee</span>
            </div>
          ...
          <div className="apply_for_mineral_sec_2 xl:py-10 md:py-5 py-4">
            <div className="page_subtitle text-center">
              Mineral Title <span>Tenure</span>
            </div>
            <div className="table_strucutre">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex text-[28px] justify-evenly">
            <div className="flex flex-col w-[260px] h-[200px] shadow-sm items-start pl-4">
              ...
              <div className="flex h-1/4 items-end text-[28px]">
                Exploration
              </div>
            ...
            <div className="flex flex-col w-[260px] h-[200px] shadow-sm items-start pl-4">
              ...
              <div className="flex h-1/4 items-end">Mining</div>
              <div className="flex h-1/4 items-end">Lease</div>
            </div>
          </div>
        </div>
      </Container>
      <div className="how_to_apply_for_mineral_title_main md:my-10 my-5 bg-[#F4FBF7] md:py-20 py-5">
        <Container>
          <div className="how_to_apply_intro mx-auto md:max-w-[600px] max-w-[90%] text-center">
            <h2 className="how_to_apply_for_mineral_heading">
              How to Apply for Mineral Title
            </h2>
            <p>
              Step by step procedure to apply for a mineral title, to embark on
      ...
      <Container>
        <div className="links_for_appliation_of_provincial">
          <div className="links_for_application_title text-center">
            <h2 className="page-title text-center max-w-[1000px] mx-auto">
              Links for Application of <span>Provincial </span> Mineral Title
            </h2>
                  ...
                  {applyingForMineralTitleData?.map((item, i) => (
                    <li key={i}>
                      <div className="mineral_title_item">
                        <div className="mineral_title_heading">
                          {item?.title}
                        </div>
