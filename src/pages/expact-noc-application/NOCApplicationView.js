...
const fetchAPIs = async(id = "") => {
    setLoading(true);
    try {
      const { data:nationalities, isError, message } = await commonAPIs(
        REQUEST_TYPES.GET,
        ENDPOINTS.GET_ALL_NATIONALITY
      );
      const { data:banksData, isError1, message1 } = await commonAPIs(
        REQUEST_TYPES.GET,
        ENDPOINTS.GET_ALL_BANKS
      );
...
const breadcrumbs = [
  ...
  <div className="addwrapper">
    ...
    <div className='breadcrumbbar mt-[50px]'>
        <BreadCrumbs breadcrumbs={breadcrumbs} /><div className="mineral-testing-title">NOC Application View</div>
    </div>
                  <h3 style={{paddingBottom: "40px" ,color:"#27ae60" }}>
                ...
                <div className="wrapper__container">
                  ...
                  >
                    ...
                    >
                      ...
                      {showNOCType ? (
                      <>
                      <h3 style={{marginTop: '10px', marginLeft: '130px',paddingBottom: '10px' ,color:"#27ae60"}}>Deposit Details</h3>
                      <Flex wrap gap="center" horizontal justify='space-around' style={{width: '100%'}} >
                        <Col className="column" flex="1 0 15%">
                               <Form.Item
                                name="DepositDate"
                    ...
                    */} 
                      ...
                      <h3 style={{marginTop: '10px', marginLeft: '130px',paddingBottom: '10px' ,color:"#27ae60"}}>Expatriate Personal Details</h3>
                      <Flex wrap gap="center" horizontal justify='space-around' style={{width: '100%'}} >
                        <Col className="column" flex="1 0 15%">
                          <Form.Item
                            name="gender"
                          ...
                          >
                            ...
                            >
                              {nationalityList.map((data) => {
                                return (
                                  <Option value={data.nationalityName}>{data.nationalityName}</Option>
                                );
                              })}
                            </Select>
                          </Form.Item>
                    ...
                    */}  
                     {/*
                        Third Page Start
                    */}
                      <h3 style={{marginTop: '10px', marginLeft: '130px',paddingBottom: '10px' ,color:"#27ae60"}}>Professional Details</h3>
                      <Flex wrap gap="center" horizontal justify='space-around' style={{width: '100%'}} >
                        <Col className="column" flex="1 0 15%">
                          <Form.Item
                            name="profession"
                    ...
                    */}
                      ...
                      <h3 style={{marginTop: '10px', marginLeft: '130px',paddingBottom: '10px' ,color:"#27ae60"}}>Purpose of Visit</h3>
                      <Flex wrap gap="center" horizontal justify='space-around' style={{width: '100%'}} >
                        <Col className="column" flex="1 0 15%">
                          <Form.Item
                            name="PurposeofVisit"
                          ...
                          >
                            <Select
                              ...
                              placeholder="Visit"
                            >
                              <Option value="WorkDrilling">
                                Work-Drilling
                              </Option>
                              <Option value="SiteVisit">Site Visit</Option>
                              <Option value="Survey">Survey</Option>
                              <Option value="Business">Business</Option>
                              <Option value="Stayandvigilanceofwork">
                                Stay and Vigilance of Work
                              </Option>
                              <Option value="InstallationofProject">
                                Installation of Plant
                              </Option>
                              <Option value="ProjectbasedSeismicActivity">
                                Project based- Seismic Activit
                              </Option>
                        ...
                        <Col className="column" flex="1 0 15%">
                          ...
                          >
                            <Input
                              placeholder="Stay and vigilance of work"
                              className={styles.inputclass}
                            />
                          </Form.Item>
                        </Col>
                      ...
                      <Flex wrap gap="center" horizontal justify='space-around' style={{width: '100%'}} >
                        <Col className="column" flex="1 0 15%">
                          ...
                          >
                            <Input
                              placeholder="Base Camp Mining Site, Chitral"
                              className={styles.inputclass}
                            />
                          </Form.Item>
                        </Col>
                    ...
                    */}
                    ...
                    <div style={{width: '78%', marginLeft: '130px'}}>
                        <h3 style={{marginTop: '10px', marginLeft: '5px',paddingBottom: '10px' ,color:"#27ae60"}}>Equipment Listings</h3>
                    ...
                    */}
                      ...
                      <h3 style={{marginTop: '10px', marginLeft: '130px',paddingBottom: '10px', color: '#27ae60'}}>Sponsor Details</h3>
                      <Flex wrap gap="center" horizontal justify='space-around' style={{width: '100%'}} >
                        <Col className="column" flex="1 0 15%">
                          <Form.Item
                            name="licensenumber"
                          ...
                          >
                            <Input
                              placeholder="Title/License Number"
                              className={styles.inputclass}
                            />
                          </Form.Item>
                        </Col>
                      ...
                      <Flex wrap gap="center" horizontal justify='space-around' style={{width: '100%'}} >
                        <Col className="column" flex="1 0 15%">
                          ...
                          >
                            <Input
                              placeholder="Name and Address of Visiting Organisations"
                              className={styles.inputclass}
                            />
                          </Form.Item>
                        </Col>
                        <Col className="column" flex="1 0 15%">
                          ...
                          >
                            <Input
                              placeholder="Name & Designation of Conducting Offical"
                              className={styles.inputclass}
                            />
                          </Form.Item>
                        </Col>
                        <Col className="column" flex="1 0 25%">
                          ...
                          >
                            <Input
                              placeholder="Name of Pakistani Offical"
                              className={styles.inputclass}
                            />
                          </Form.Item>
                        </Col>
                      ...
                      <Flex wrap gap="center" horizontal justify='space-around' style={{width: '100%'}} >
                        <Col className="column" flex="1 0 15%">
                          ...
                          >
                            <Input
                              placeholder="Contact No. of Pakistani Offical"
                              className={styles.inputclass}
                            />
                          </Form.Item>
                        </Col>
                        <Col className="column" flex="1 0 15%">
                          ...
                          >
                            <Input
                              placeholder="Address of Pakistani Offical"
                              className={styles.inputclass}
                            />
                          </Form.Item>
                        </Col>
                        <Col className="column" flex="1 0 25%">
                          ...
                          >
                            <Input
                              placeholder="CINC No. of Pakistani Offical"
                              className={styles.inputclass}
                            />
                          </Form.Item>
                        </Col>
                    ...
                    */}
                      ...
                      <h3 style={{marginTop: '10px', marginLeft: '130px',paddingBottom: '10px' ,color:"#27ae60"}}>Foreigner's Accommodation Details</h3>
                      <Flex wrap gap="center" horizontal justify='space-around' style={{width: '100%'}} >
                        <Col className="column" flex="1 0 15%">
                          <Form.Item
                        ...
                        <Col className="column" flex="1 0 15%">
                          ...
                          >
                            <Input
                              placeholder="Places with Address"
                              className={styles.inputclass}
                            />
                          </Form.Item>
                        </Col>
                    ...
                    */}
                    {
                      ...
                      <>
                    <div style={{width: '78%', marginLeft: '130px'}}>
                    <h3 style={{marginTop: '10px', marginLeft: '5px',paddingBottom: '10px' ,color:"#27ae60"}}>Travel History Listing</h3>
                    <ConfigProvider
                                        theme={{
                                            token: {
                                                /* Here is your global tokens */
                                      ...
                                      >
                    <Table
                    dataSource={data.nocApplicationTravelHistory}
                    columns={columns1}
                    />
                    </ConfigProvider>
                    </div>
                    ...
                    */}
                      ...
                      <h3 style={{marginTop: '10px', marginLeft: '130px',paddingBottom: '10px' ,color:"#27ae60"}}>Visa Grant Details</h3>
                      <Flex wrap gap="center" horizontal justify='space-around' style={{width: '100%'}} >
                        <Col className="column" flex="1 0 15%">
                          <Form.Item
                      ...
                      </Flex><Flex wrap gap="center" horizontal justify='space-around' style={{width: '100%'}} >
                        <Col className="column" flex="1 0 15%">
                          <Form.Item
                            name="VisaStartDate"
