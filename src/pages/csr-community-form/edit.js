    ...
    useEffect(() => {
      const fetchDataById = async () => {
        try {
          ...
          form.setFieldsValue({
            Name: fetchedData.personName,
            MobileNumber: parseInt(fetchedData.mobileNumber),
            Email: fetchedData.email,
          });
          setModifiedValues({
            commentType: fetchedData.commentType,
    ...
    const handleSubmission = async (values) => {
      try {
        ...
        const vocieObj = {
          ...
          commentType: modifiedValues.commentType,
        };
          ...
          <div className="grid lg:grid-cols-3 sm:grid-cols-2 gap-10">
            ...
            >
              <div className="relative mt-2 w-full">
                <select
                  name="commentType"
                  value={modifiedValues.commentType || ""}
                  onChange={handleChange}
