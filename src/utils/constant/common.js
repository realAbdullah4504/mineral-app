...
export const mineralPotential2 = [
  ...
  },
  {
    ...
    project: " Sino Sindh Thar Coal Block I  Sindh Engro Thar Block II",
  ...
  },
  {
    ...
    project: " Punjab Mineral Company Pvt Ltd",
...
export const mineralClassification = [
  {
    ...
    description:
      "With the 5th biggest copper & gold mine in the world, Pakistan estimates the annual profit from these mines to be $3.64 billion. With belts of chromite deposits in Balochistan & KPK, Pakistan boasts an estimated reserve of 2.5 million tons, while the Chagai Iron Ore deposits are being produced at 24,000 tons per annum.",
    avatar: Metallic,
    icon: MetallicIcon,
  },
  {
  ...
  },
  {
    title: "Gemstones",
    description:
      "The mines in Pakistan boast world’s finest quality Aquamarine, emeralds and pink topaz. From the rugged peaks of the Gilgit-Baltistan region to the remote valleys of Khyber Pakhtunkhwa, these mining sites have captivated gemstone enthusiasts, collectors, and geologists alike.",
    avatar: gypsum,
    icon: DiamondIcon,
  },
  {
  ...
  },
  {
    title: "Energy",
    description:
      "With the world’s 5th largest coal mine, Pakistan produces 9 million tons of coal every year. This coal is used for power generation in various industries. Moreover, with extensive reserves of 297 billion tons of marble, there are more than 40 types of natural colored marbles.",
    avatar: Energy,
    icon: EnergyIcon,
  },
];
